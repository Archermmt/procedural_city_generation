...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            _translate("MainWindow", "Procedural City Generation", None)
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.roadmap_tab),
            _translate("MainWindow", "Roadmap Generation", None),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.polygons_tab),
            _translate("MainWindow", "Polygon Extraction", None),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.building_generation_tab),
            _translate("MainWindow", "Building Generation", None),
        )
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.visualization_tab),
            _translate("MainWindow", "Visualize in Blender", None),
        )
        self.advanced_group.setTitle(_translate("MainWindow", "Commands", None))
        self.clean_directories.setText(
            _translate("MainWindow", "Clean Directories", None)
        )
        self.run_tests.setText(_translate("MainWindow", "Run Tests", None))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.advanced_tab),
            _translate("MainWindow", "Advanced", None),
        )
